        ...
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
          <div className="p-8">
            <div className="flex items-center justify-center mb-6">
              <img src="https://via.placeholder.com/300" alt="Employee" className="w-48 h-48 object-cover rounded-full" />
            </div>
            ...
            <Link href="/edit-employee/1" className="bg-blue-600 w-auto px-4 py-2 text-white-400 hover:bg-blue-800 rounded-md">  Edit  </Link>
            </div>
